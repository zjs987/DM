...
def w2v_feature_extract(root_path, filename, w2v_path):
    ...
    pickle.dump([X_train_tid, X_train, y_train, word_embeddings, relation], open(root_path + "/pheme_files/train.pkl", 'wb'))
    pickle.dump([X_dev_tid, X_dev, y_dev], open(root_path + "/pheme_files/dev.pkl", 'wb'))
    pickle.dump([X_test_tid, X_test, y_test], open(root_path + "/pheme_files/test.pkl", 'wb'))
